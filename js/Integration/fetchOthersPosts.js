...
async function fetchEventsPosts(){
    ...
    if(checkFetchedData.faculty === "Faculty of Business"){
        response = await fetch("https://university-social-network-be.herokuapp.com/getPostsByCategoryAndFaculty/Others/Business")
    }

    else if(checkFetchedData.faculty === "Faculty of IT"){
        response = await fetch("https://university-social-network-be.herokuapp.com/getPostsByCategoryAndFaculty/Others/IT")
    }

    else {
        response = await fetch("https://university-social-network-be.herokuapp.com/getPostsByCategory/Others")        
    }
